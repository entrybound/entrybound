export const meta = {
  name: 'eb-research-phase-b1c-corpus-baselines',
...
${COVERAGE}
Checkpoint the verified group (subject noting it supersedes the WIP checkpoint; paths: research/corpus/sources/g5-media.json, research/corpus/generators/g5-media, pins/fingerprints files with prefixes f12-, f13-). Return files, commits, summary, problems.`, { label: 'corpus:g5-verify', phase: 'Corpus', schema: RESULT }),
])
...
Checkpoint: research/corpus (manifest.json, statistics.json, heldout-lock.json, coverage.md, licenses.md, methodology.md, tools) and research/tools/ebr + tests if changed. Return files, commits, summary with totals, problems.`, { label: `corpus:assemble:r${round}`, phase: 'Assemble', schema: RESULT })
...
Checkpoint research/baselines and the EXP-BASE-SIZE raw/normalized outputs. Return files, commits, summary, problems.`, { label: 'baselines:tooling', phase: 'Baselines', schema: RESULT })
