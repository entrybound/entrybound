...
/// Required capability for Entry-v3 and canonical platform/security metadata-v1.
pub const FEATURE_PLATFORM_SECURITY_METADATA_V1: u64 = 1 << 16;
pub(crate) const SUPPORTED_INCOMPAT_FEATURES: u64 = FEATURE_CROSS_FILE_COMPRESSION_V1
    ...
    | FEATURE_PLATFORM_SECURITY_METADATA_V1
