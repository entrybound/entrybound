...
pub enum ReasonCode {
    ...
    InvalidPosixMetadata,
    InvalidHardlinkGroup,
    InvalidXattr,
    DuplicateXattr,
    InvalidSparseMap,
    InvalidAcl,
    InvalidWindowsSecurityDescriptor,
    InvalidWindowsMetadata,
    InvalidReparsePoint,
    InvalidMacosMetadata,
    ...
    LegacyExportLossyApprovalRequired,
    LegacyExportRefused,
    LegacyExportTargetInvalid,
    ZipStructureInvalid,
    ...
    SevenZStructureInvalid,
    SevenZUnsupportedFeature,
    SevenZUnsupportedCoder,
    SevenZIntegrityMismatch,
    SevenZConflictDivergence,
    SevenZConflictIrreconcilable,
    SevenZUnsafePath,
    UnsupportedEntryKind,
    SourceUnstable,
    RandomAccessPolicyRefused,
    RandomAccessNotIndexed,
    RandomAccessEntryNotFound,
    RandomAccessEntryNotFile,
    RandomAccessDependencyInvalid,
    HttpRangeUnsupported,
    HttpRangeInvalid,
    InputNotDirectory,
    ExtractionCollision,
    ExtractionContainmentUnavailable,
    ExtractionUnsafeSymlink,
    CommandUsage,
...
impl ReasonCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::InvalidSymlinkTarget => "EB_EAM_INVALID_SYMLINK_TARGET",
            Self::InvalidPosixMetadata => "EB_EAM_INVALID_POSIX_METADATA",
            Self::InvalidHardlinkGroup => "EB_EAM_INVALID_HARDLINK_GROUP",
            Self::InvalidXattr => "EB_EAM_INVALID_XATTR",
            Self::DuplicateXattr => "EB_EAM_DUPLICATE_XATTR",
            Self::InvalidSparseMap => "EB_EAM_INVALID_SPARSE_MAP",
            Self::InvalidAcl => "EB_EAM_INVALID_ACL",
            Self::InvalidWindowsSecurityDescriptor => "EB_EAM_INVALID_WINDOWS_SECURITY_DESCRIPTOR",
            Self::InvalidWindowsMetadata => "EB_EAM_INVALID_WINDOWS_METADATA",
            Self::InvalidReparsePoint => "EB_EAM_INVALID_REPARSE_POINT",
            Self::InvalidMacosMetadata => "EB_EAM_INVALID_MACOS_METADATA",
            ...
            Self::LegacyExportLossyApprovalRequired => "EB_LEGACY_EXPORT_LOSSY_APPROVAL_REQUIRED",
            Self::LegacyExportRefused => "EB_LEGACY_EXPORT_REFUSED",
            Self::LegacyExportTargetInvalid => "EB_LEGACY_EXPORT_TARGET_INVALID",
            ...
            Self::SevenZStructureInvalid => "EB_7Z_STRUCTURE_INVALID",
            Self::SevenZUnsupportedFeature => "EB_7Z_UNSUPPORTED_FEATURE",
            Self::SevenZUnsupportedCoder => "EB_7Z_UNSUPPORTED_CODER",
            Self::SevenZIntegrityMismatch => "EB_7Z_INTEGRITY_MISMATCH",
            Self::SevenZConflictDivergence => "EB_7Z_CONFLICT_DIVERGENCE",
            Self::SevenZConflictIrreconcilable => "EB_7Z_CONFLICT_IRRECONCILABLE",
            Self::SevenZUnsafePath => "EB_7Z_UNSAFE_PATH",
            Self::UnsupportedEntryKind => "EB_INPUT_UNSUPPORTED_ENTRY_KIND",
            Self::SourceUnstable => "EB_INPUT_SOURCE_UNSTABLE",
            Self::RandomAccessPolicyRefused => "EB_RANDOM_ACCESS_POLICY_REFUSED",
            Self::RandomAccessNotIndexed => "EB_RANDOM_ACCESS_NOT_INDEXED",
            Self::RandomAccessEntryNotFound => "EB_RANDOM_ACCESS_ENTRY_NOT_FOUND",
            Self::RandomAccessEntryNotFile => "EB_RANDOM_ACCESS_ENTRY_NOT_FILE",
            Self::RandomAccessDependencyInvalid => "EB_RANDOM_ACCESS_DEPENDENCY_INVALID",
            Self::HttpRangeUnsupported => "EB_HTTP_RANGE_UNSUPPORTED",
            Self::HttpRangeInvalid => "EB_HTTP_RANGE_INVALID",
            ...
            Self::ExtractionUnsafeSymlink => "EB_EXTRACT_UNSAFE_SYMLINK",
